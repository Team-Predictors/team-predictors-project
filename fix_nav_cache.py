...
nav_template = '''    <!-- UNIFIED BIG NAVBAR -->
    <nav class="w-full h-[105px] px-8 lg:px-20 flex items-center justify-between bg-white border-b border-gray-100 z-50 relative shrink-0">
        <!-- Logo -->
        <a href="index.html?v=12" class="flex items-center gap-3 cursor-pointer">
        ...
        <div class="hidden lg:flex items-center gap-10 text-[14px] font-bold text-gray-700" style="font-family: 'Inter', sans-serif;">
            <a href="index.html?v=12" class="hover:text-green-700 transition">Home</a>
            <a href="about.html?v=12" class="hover:text-green-700 transition">About</a>
            <a href="features.html?v=12" class="hover:text-green-700 transition">Features</a>
            <a href="how_it_works.html?v=12" class="hover:text-green-700 transition">How It Works</a>
            <a href="contact.html?v=12" class="hover:text-green-700 transition">Contact</a>
        </div>

        <!-- Button -->
        <div>
            <a href="login_demo.html?v=12" class="bg-[#126f43] hover:bg-green-800 text-white px-8 py-3 rounded-md font-bold text-[14px] transition-colors shadow-md" style="font-family: 'Inter', sans-serif;">
                Login
            </a>
        </div>
    </nav>'''
